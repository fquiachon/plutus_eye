...
@app.route('/global/volume/transaction/<string:transaction>', methods=['GET'])
@jwt_required
...
@app.route('/global/volume', methods=['POST'])
@jwt_required
...
@app.route('/global/volume/<string:ticker>', methods=['GET'])
@jwt_required
